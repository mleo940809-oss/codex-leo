...
|---|---|---|---|---|---|
| Weixin摇一摇活动管理 | 统一创建、维护、查看和执行商品券活动 | 覆盖活动列表、活动新增、活动编辑、活动修改、活动详情与批次管理，统一活动创建、草稿接续、生效前修订、只读详情与批次发放管理能力 | 2026-05-10 | V1.1 | 业务方待评审确认 |
...
| 冻结/归档记录 | 是 | 记录冻结版本、时间、责任人 | `docs/prototype/Weixin摇一摇/archive/Weixin摇一摇_v1.1_20260510/archive-manifest.md` |
...
| 交付确认记录 | 是 | 签核、确认人和确认日期 | `docs/prototype/Weixin摇一摇/archive/Weixin摇一摇_v1.1_20260510/archive-manifest.md` |
...
| 归档项 | 要求 | 说明 | 记录位置 |
|---|---|---|---|
| 归档清单 | 是 | 记录本次冻结归档的内容 | `docs/prototype/Weixin摇一摇/archive/Weixin摇一摇_v1.1_20260510/archive-manifest.md` |
| 原型活链接 | 是 | 记录冻结时可回读的正式原型链接 | `docs/prototype/Weixin摇一摇/archive/Weixin摇一摇_v1.1_20260510/archive-manifest.md` |
| 对应 PRD 版本 | 是 | 记录关联的 PRD 冻结版本号 | `docs/prototype/Weixin摇一摇/archive/Weixin摇一摇_v1.1_20260510/archive-manifest.md` |
| 源文件 / 导出文件 | 是 | 记录 Figma / HTML / 导出包位置 | `docs/prototype/Weixin摇一摇/archive/Weixin摇一摇_v1.1_20260510/archive-manifest.md` |
| 关键页面预览图 | 是 | 记录冻结时的页面预览证据 | `docs/prototype/Weixin摇一摇/archive/Weixin摇一摇_v1.1_20260510/archive-manifest.md` |
| 归档确认人 / 时间 | 是 | 记录归档责任人和时间 | `docs/prototype/Weixin摇一摇/archive/Weixin摇一摇_v1.1_20260510/archive-manifest.md` |
